...
class person{
    ...
    virtual void display(){
        cout<<"hello i am god from main"<<this->a<<this->name<<endl;
    }
    ~person(){}
};
class student: virtual public person{
    ...
    virtual void display(){
        //person::display();
        cout<<"hello world from 1st derived\t"<<this->person::a<<this->person::name<<this->student::name<<endl;
...
class employee: virtual public person{
    ...
    virtual void display(){
        cout<<"hello i am employee 1st derived\t"<<this->person::a<<this->person::name<<this->employee::name<<endl;
    }
    ~employee(){}
};
class teaching_asistant:public student,public employee{
    ...
    void display(){
        cout<<"i am teaacher"<<this->person::a<<this->person::name<<this->teaching_asistant::name<<endl;
        person::display();
